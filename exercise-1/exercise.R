...
original.numbers <- c(1:100)
original.number.check <- original.numbers / 2
round.number.check <- round(original.number.check)
indices <- round.number.check == original.number.check
even <- original.numbers[indices]
print(even)
